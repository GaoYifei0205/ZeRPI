...
if __name__ == '__main__':
    ...
    log_path = os.path.join("/home/gaoyifei/RNARepresentation/out/GCN/zero_shot", "10_10.txt")
    ...
    for type_, oneset in zip(["test"], [test_dataset]):
    ...
    th_val = [0.]
    pos_test, neg_test, th_test, protein_cos_test, protein_label_test, id_mapping_test, binary_label_test, binary_pred_test_prob, rna_feats, protein_feats = trainer_.get_similarity(test_loader, protein_id)
    ...
    with open("/home/gaoyifei/RNARepresentation/a_refresh/res/ours_gat_10_10.pkl", "wb") as f:
